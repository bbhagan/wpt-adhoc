      ...
      <div className="TestConfigurationContainer">
        <fieldset>
          <div className="container">
              ...
              <div className="row">
                  <div className="col-8">
                      <TestConfigurationURLs urls={this.state.urls} updateURLs={this.updateURLs} />
                      <TestConfigurationAddMoreURLs addMoreURLs={this.addMoreURLs}/>
                  </div>
                  <div className="col-4">
          ...
          <div className="container">
            <h2 onClick={this.handleToggleAdvancedConfig} className='fakeLink'>
                Test Configuration <span className="expand">{this.state.advancedConfigOpen ? '\u25BC' : '\u25BA'} </span>
            </h2>
