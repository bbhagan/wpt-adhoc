...
class TestsInProgress extends React.Component {
  ...
  render() {
    const mergedTests = [
      ...this.props.testsInProgress,
      ...this.props.afterTestsInProgress,
    ];
    const mergedTotalNumberOfTests =
      this.props.totalNumberOfTests + this.props.totalNumberOfAfterTests;
      ...
      return (
        <div className="TestsInProgressContainer">
          <div className="wptah-section clearfix">
            <h2>
              Test(s) in Progress{" "}
              {this.renderDoneInProgressToggle(
                mergedTests,
                mergedTotalNumberOfTests
              )}
            </h2>
