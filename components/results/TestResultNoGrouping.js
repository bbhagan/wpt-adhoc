...
class TestResultNoGrouping extends React.Component {
  ...
  render() {
    const validAfterTest =
      ...
      this.props.afterTest.location &&
      this.props.afterTest.data;
    return (
      <div className="TestResultNoGroupingContainer">
        <TestResultHeaderDescription
          test={this.props.test}
          afterTest={this.props.afterTest}
        />
        <table className="table table-hover">
          <TestResultTableHeader resultOptions={this.props.resultOptions} />
          <tbody>
            {this.renderResultsLines(
              this.props.test,
              validAfterTest ? "Before" : ""
            )}
            ...
            {validAfterTest
              ? this.renderResultsLines(this.props.afterTest, "After")
              : ""}
            {validAfterTest
              ? this.renderAverageLine(this.props.afterTest, "After")
              : ""}
            {validAfterTest ? (
